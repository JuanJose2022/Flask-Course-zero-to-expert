...
def scrapy_data():
    ...
    if form.validate_on_submit():
        ...
        #         https://listado.mercadolibre.com.co/iphone12#D[A:iphone12]
        url = f"https://listado.mercadolibre.com.co/{search}#D[A:{search}]"
             
        response = requests.get(url)
        soup = BeautifulSoup(response.content, "html.parser")
        dom = etree.HTML(str(soup))#Convert the HTML to string
        ...
        data_articles = dom.xpath("//ol[@class='ui-search-layout ui-search-layout--stack shops__layout']//div[@class='poly-card__content']//a/@href")
        #"//ol[@class='ui-search-layout ui-search-layout--stack shops__layout']//div[@class='poly-card__content']//a/@href"
